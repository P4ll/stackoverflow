...
| Кол-во ответов | Кол-во ответов пользователя | N |
| Людей затронул | Примерное кол-во, когда пользователи видели полезное сообщение от этого пользователя | N |
| Кол-во вопросов | Кол-во вопросов пользователя | N |
...
| Рейтинг пользователя | “Объективная” оценка полезности пользователя для системы | N |